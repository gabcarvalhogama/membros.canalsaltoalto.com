...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23/06/2024 às 21:51
...
(1, 'Teste 2 3', '<p>teste acb</p>', 'uploads/2024/06/20241615316243.jpg', 1, 2, '2024-06-23 13:49:25', NULL, '2024-06-23 14:17:09');
...
(10, 1, 'ACENTUE GESTÃO CONTABIL E EMPRESARIAL', 'Contabilidade consultiva, BPO Financeiro (Terceirização do financeiro), Consultoria tributária, Legalização de empresas.', 'uploads/2024/06/20240908258005.jpg', 0, '', 0, 0, '', '', '', '', '27981514959', 'https://www.instagram.com/acentue.com.br', 'https://www.acentue.com.br/', '', 1, '2024-06-23 16:09:08', '2024-06-23 16:46:43');
...
(1, 'Descomplicando o Imposto de Renda', NULL, '2024-03-25 16:00:00', 'https://membros.canalsaltoalto.com/wp-content/uploads/2024/03/D5EFAC97-4FFD-4522-B7EC-CF864F510858.png', '\r\n<p>Chegou a hora de descomplicar o Imposto de Renda!&nbsp;</p>\r\n\r\n\r\n\r\n<p>Não perca essa oportunidade de aprender informações práticas que toda empreendedora deve ficar atenta.&nbsp;</p>\r\n\r\n\r\n\r\n<p>Dia 25/03, às 19h, no link abaixo.&nbsp;</p>\r\n\r\n\r\n\r\n<p>Contaremos com a presença da empresária contábil Andressa Cardoso. Não fique de fora, garanta sua vaga!&nbsp;</p>\r\n\r\n\r\n\r\n<p>LINK DA AULA</p>\r\n\r\n\r\n\r\n<p> <a href=\"https://meet.google.com/rsb-yeez-gvg\" target=\"_blank\" rel=\"noopener\">https://meet.google.com/rsb-yeez-gvg</a><br>Ou disque: &#x202A;(BR) +55 21 4560-7310&#x202C; PIN: &#x202A;782 720 749&#x202C;#</p>\r\n\r\n\r\n', 'descomplicando-imposto-de-renda', 1, 1, '2024-05-19 19:36:55', '2024-05-19 19:55:26');
...
(5, 'teste', '<p><img class=\"img-responsive\" src=\"../../uploads/2024/06/667737d10506e.png\" alt=\"\"></p>', 1, 2, '2024-06-22 17:45:11', '2024-06-22 17:45:11', NULL);
...
(1, 'O Planejamento é a chave do sucesso', 'CEO do Canal Salto Alto, Tati Serafim, explica porque planejar é tão importante para o sucesso do nosso negócio.', '<p>Quase 30% dos MEIs (Microempreendedores Individuais) fecham as portas no Brasil antes de completarem 5 anos de empresa, e 17% dos entrevistados disseram que não fizeram nenhum planejamento ao abrir o empreendimento. Os dados foram publicados pelo SEBRAE após pesquisa realizada entre 2028 e 2021.</p>\n\n<p>É comum em nossa rede de empreendedoras ver mulheres perdidas em seus negócios, não sabem qual será o próximo passo e nem mesmo se a empresa está tendo lucro ou prejuízo. \"A verdade é que não basta ser boa no que você faz, uma empreendedora precisa saber de gestão, financeiro e também de marketing\", afirma Tati Serafim consultora de empreendedorismo e marketing e CEO do Canal Salto Alto.</p>\n\n<p>Algumas pessoas não planejam por falta de tempo, falta de atitude ou simplesmente por falta de conhecimento. E dessas três causas, duas uma rede de apoio a empreendedoras como Canal Salto Alto pode ajudar em duas delas: a falta de tempo e a falta de conhecimento. </p>\n\n<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/hRlDybEnJiQ?si=1GuENI0i24kG6fWp\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></iframe>\n\n<h2>COMO PLANEJAR O MEU NEGÓCIO</h2>\n\n<p>Primeiro começamos trazendo conhecimento para essas mulheres. Mostrando algumas das várias ferramentas que podem nos auxiliar com o planejamento e ensinando como usá-las de forma simples e prática. </p>\n\n<p>E quando aprendemos a planejar, desde o que vamos fazer no dia até o que queremos para os próximos 5 anos da empresa, fazemos um melhor uso do nosso tempo e com isso diminuímos a sua escassez.</p>\n\n<p>Porém, a falta de atitude não é ensinada. As empreendedoras precisam tomar para si a responsabilidade de planejar o seu negócio, de estudar e de se especializar naquilo que ainda não sabe fazer. Abrir uma empresa não deve ser encarada como um passa tempo, um extra ou algo temporário. Tudo que damos atenção e focamos, cresce.</p>\n\n<h2>OBJETIVO E METAS</h2>\n\n<p>Segundo Tati Serafim, objetivos e metas são duas coisas distintas. Objetivo é aonde você quer chegar e metas são as etapas que você precisará conquistar até chegar ao seu objetivo. A dica é você colocar no papel o seu objetivo e dividi-lo em etapas, como se fossem degraus. </p>\n\n<p>Além disso nossos objetivos e metas precisam ter prazo para acontecerem, ou seja, o ideal é você colocar data neles. E ainda é preciso um acompanhamento. Seja num caderno, num quadro, numa planilha de excel ou num sistema moderno, uma empreendedora precisa ter uma forma de acompanhar o seu planejamento para corrigir possíveis falhas e mudar o que for necessário.</p>\n\n<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/gd-0ysbnMDo?si=Hmq92PR_sRmAlidX\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></iframe>\n\n<p>E por fim é trabalhar duro e ter muita proatividade. \"Não conheço nenhum caso de uma empreendedora de sucesso que precisou de pouco trabalho ou pouco estudo para chegar onde chegou. Todas, sem exceção, se empenharam muito para fazer acontecer em suas empresas. Então com um bom planejamento e muito trabalho, o sucesso é possível para todas\", garante Tati Serafim.</p>\n\n<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/DHjDB5jG5nU?si=Go-5idrOPLpdMMrT\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></iframe>\n\n\n<p class=\"has-large-font-size\"><strong><a href=\"https://membros.canalsaltoalto.com/\">SEJA UMA EMPREENDEDORA MEMBRO VOCÊ TAMBÉM!</a></strong></p>\n', 'uploads/2024/02/planejamento-e-a-chave-do-sucesso-empreendedorismo-feminino-canal-salto-alto.jpg', 1, 'planejamento-e-a-chave-do-sucesso', '2024-05-09 12:08:25', '2024-05-09 12:08:25', NULL),
(2, 'Vem aí o EMPRETEC exclusivo para empreendedoras em Linhares/ES', 'O renomado programa de formação de empreendedores do Sebrae, agora voltado para o público feminino, acontecerá entre os dias 10 e 15 de junho. GARANTA SUA VAGA!', '<p><em><strong>O renomado programa de formação de empreendedores do Sebrae, agora voltado para o público feminino, acontecerá entre os dias 10 e 15 de junho.</strong></em>&nbsp;<em><strong>GARANTA SUA VAGA!</strong></em></p>\n\n\n\n<p>Empreendedora, se você deseja alcançar o sucesso e desenvolver todo o seu potencial está chegando uma grande oportunidade, o Empretec Delas. A versão do renomado programa de formação de empreendedores voltada para o público feminino vai acontecer entre os dias 10 e 15 de junho e as inscrições já estão abertas.</p>\n\n\n\n<p>O Canal Salto Alto, a rede de empreendedoras mais completa do Espírito Santo, com intuito de apoiar o crescimento das empreendedoras, está promovendo esta importante formação e trazendo mais detalhes.</p>\n\n\n<figure>\n	<img decoding=\"async\" src=\"https://canalsaltoalto.com/wp-content/uploads/2024/04/empretec-sebrae-empreendedorismo-feminino-2-1024x683.jpg\" />\n</figure>\n\n\n<p>O Empretec será direcionado tanto para empreendedoras iniciantes, quanto para empresárias que já tenham experiência no ramo, mulheres que queiram transformar a forma de pensar a vida e os negócios.</p>\n\n<p>“O Sebrae Linhares, optou este ano em realizar o Seminário Empretec com uma versão exclusiva e adaptada especificamente para atender às necessidades e desafios enfrentados pelo público feminino, visto a força que as mulheres de Linhares têm apresentado no contexto econômico municipal. Este evento representa um passo significativo rumo à equidade de gênero no mundo dos negócios, oferecendo uma oportunidade única de capacitação e empoderamento para mulheres empreendedoras”, explica Érica Altoé, analista Sebrae Linhares/ES.</p>\n\n<p><strong>Formação da ONU</strong></p>\n\n\n\n<p>Criado pela Organização das Nações Unidas (ONU), o seminário proporciona um ambiente seguro e inspirador para que mulheres possam desenvolver habilidades empreendedoras, fortalecer sua confiança e expandir suas redes de contatos. O Empretec exclusivo para mulheres acontece nos dias 10 a 15 de junho de 2024, no auditório do Sebrae Linhares, oferecendo conhecimento prático e ferramentas essenciais para o sucesso nos negócios, mas também contribui para o fortalecimento da economia local e regional, impulsionando o desenvolvimento sustentável e inclusivo.</p>\n\n\n\n<figure>\n	<img src=\"https://canalsaltoalto.com/wp-content/uploads/2024/04/empretec-sebrae-empreendedorismo-feminino-1-1024x683.jpg\" />\n</figure>\n\n<p><strong>SE LIGA:</strong></p>\n\n<p><strong><em>Empretec exclusivo para mulheres</em></strong></p>\n<p><strong><em>Turma Linhares/ES</em></strong><strong><em></em></strong></p>\n<p><strong><em>De 10 a 15 de junho</em></strong><strong><em></em></strong></p>\n<p><strong><em>No auditório do Sebrae Linhares</em></strong><strong><em></em></strong></p>\n<p><strong><em>Investimento: R$1.300,00 à vista ou em até 10x sem juros no cartão</em></strong></p>\n\n\n<p>\n	<a href=\"https://es.loja.sebrae.com.br/empretec-delas-333199723\" target=\"_blank\" rel=\"noopener\">INSCREVA-SE AQUI</a>\n</p>\n\n\n<iframe title=\"Vem aí o Empretec exclusivo para empreendedoras\" width=\"800\" height=\"450\" src=\"https://www.youtube.com/embed/TmcfytawSkE?feature=oembed\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></iframe>\n\n\n\n<p><strong>CONTEÚDO</strong> <strong>DO EMPRETEC</strong></p>\n\n\n\n<p>Ao participar do Empretec, você será desafiada em atividades práticas e embasadas cientificamente, que explorarão as 10 características essenciais de uma empreendedora de sucesso:</p>\n\n\n\n<p>Durante o seminário a participante é desafiada em atividades práticas e cientificamente fundamentadas, que apontam como uma empreendedora de sucesso age, tendo como base 10 características comportamentais:<br>Busca de oportunidade e iniciativa<br>Persistência<br>– Correr riscos calculados<br>– Exigência de qualidade e eficiência<br>– Comprometimento<br>– Busca de informações<br>– Estabelecimento de metas<br>– Planejamento e monitoramento sistemáticos<br>– Persuasão e rede de contatos<br>– Independência e autoconfiança<br>Para o desenvolvimento dessas características, são usadas as ferramentas: design thinking, persona, modelagem de negócios, pitch elevator, e plano de ação.</p>\n\n\n\n<p><strong>CARGA HORÁRIA</strong></p>\n\n\n\n<p>O Empretecé um seminário de imersão de 60 horas, distribuídas em 6 (seis) dias, de 08 às 18 horas. Prepare-se para uma experiência única que transformará sua visão de negócios.</p>\n\n\n\n<p>Para participar desta jornada empreendedora e ter acesso a todo o conhecimento que o Empretec oferece, siga o passo a passo abaixo:</p>\n\n\n\n<p>Seleção com Inteligência Artificial: Após a inscrição, fique atento ao seu e-mail, você irá receber um link para uma experiência inovadora! Nossa Inteligência Artificial o conduzirá a um questionário para identificar seu perfil empreendedor. Essa tecnologia nos permite compreender ainda melhor suas características comportamentais, proporcionando uma jornada altamente relevante para o seu desenvolvimento.</p>\n\n\n\n<p>Confirmação de Inscrição: Após a entrevista com nossa Inteligência Artificial, você receberá o resultado da sua seleção indicando se você está apto além de informações necessárias para a sua participação.<br>Imersão no Empretec Urbano: Agora você está pronto(a) para embarcar em seis dias intensos e transformadores! Durante o seminário, você será desafiado(a) em atividades práticas e embasadas cientificamente, que o(a) levarão a desenvolver as 10 características essenciais de um empreendedor de sucesso.</p>\n\n\n\n<p>Lembrando que nosso compromisso com a excelência continua inabalável. Caso a Inteligência Artificial identifique que o momento não é ideal para sua participação, o valor da inscrição será devolvido integralmente. Buscamos sempre proporcionar a melhor experiência para você.</p>\n\n\n\n<p>Estimule a empreendedora que existe em você. Empretec é atitude! Não perca a oportunidade de participar de uma turma exclusiva para mulheres!</p>\n\n\n\n<p><strong>CERTIFICADO:</strong></p>\n\n\n\n<p>No menu principal da Loja Virtual, acesse CERTIFICADOS, e você poderá baixar todos os certificados de eventos que já participou.</p>\n\n\n\n<p>Caso seu certificado não esteja disponível, gentileza enviar e-mail para suporte@es.sebrae.com.br, informando seu CPF e nome do evento que participou.</p>\n\n\n\n<figure>\n<iframe title=\"O que é o Canal Salto Alto?\" width=\"800\" height=\"450\" src=\"https://www.youtube.com/embed/ERrRshiMc8Y?feature=oembed&#038;enablejsapi=1&#038;origin=https://canalsaltoalto.com\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></iframe>\n</figure>', 'uploads/2024/04/empretec-sebrae-empreendedorismo-feminino.jpg', 1, 'empretec-linhares-es', '2024-04-24 10:39:44', '2024-04-24 10:39:44', '2024-04-24 10:39:44'),
(3, 'Mentalidade Financeira – o que é e como conquistar', 'A mentalidade da riqueza é a maneira como uma pessoa pensa e se relaciona com o dinheiro e a riqueza. Mas, muitas empreendedoras possuem crenças que limitam e a afastam da prosperidade financeira.\n\n', '\r\n<p><strong><em>A mentalidade da riqueza é a maneira como uma pessoa pensa e se relaciona com o dinheiro e a riqueza. Mas, muitas empreendedoras possuem crenças que limitam e a afastam da prosperidade financeira.</em></strong></p>\r\n\r\n\r\n<p>Uma mentalidade financeira próspera é a crença de que a riqueza é algo possível e que o dinheiro pode ser usado como uma ferramenta para melhorar a qualidade de vida e alcançar objetivos pessoais e financeiros. Neste vídeo, a empresária e master coach Andriele Mariano, explica melhor para nós como isso acontece na prática, além de dar várias dicas para conquistarmos nossa mentalidade financeira próspera.</p>\r\n\r\n\r\n\r\n<p>“O que nós vivemos ao longo da vida, principalmente na infância, em relação ao dinheiro e a prosperidade, influencia diretamente na vida adulta. Eu, por exemplo, vi os meus pais ‘quebrarem’ três vezes até os meus 12 anos. E não entendi porque eu chegava até um certo patamar e não conseguia ir além. Assim acontece com outras pessoas”, explica Andriele.</p>\r\n\r\n\r\n\r\n<p><a href=\"https://canalsaltoalto.com/redacao-csa/conteudo/como-emitir-nota-fiscal-de-mei/\">Como emitir nota fiscal de MEI</a></p>\r\n\r\n\r\n\r\n<p>Para a master coach, outra coisa que bloqueia mentalidade financeira é nós mulheres sairmos do nosso papel de mulher. “O papel de provedor é do homem, e muitas vezes a gente se perde ao tentar suprir uma falta, ou por algo que aconteceu na infância, inconscientemente ocupamos o lugar da figura masculina, mas que não é nosso”.</p>\r\n\r\n\r\n\r\n<p><strong>Como alcançar a mentalidade financeira</strong></p>\r\n\r\n\r\n\r\n<p>A primeira dica da master coach Andriele Mariano dá a nós empreendedoras do Canal Salto Alto, é que ocupemos o nosso lugar de mulher. “Precisamos tirar das nossas costas o peso da responsabilidade de prover. Depois, não se culpar quando sairmos para trabalhar, pois tempo de qualidade com os filhos é diferente de muito tempo com eles. E para finalizar, precisamos buscar aquilo que satisfaz o nosso coração e não apenas o que dá dinheiro, pois se não, sempre faltará algo em nossas vidas”, completa.</p>\r\n\r\n\r\n\r\n<p><a href=\"http://master coach Andriele Mariano\" target=\"_blank\">ASSISTA A ENTREVISTA COMPLETA COM ANDRIELE MARIANO</a></p>\r\n\r\n\r\n\r\n<p>Esses e outros conteúdos sobre empreendedorismo feminino você encontra aqui no site e em nosso canal no Youtube.<strong> INSCREVA-SE!</strong></p>', 'uploads/2024/04/mentalidade-financeira-livro-paulo-vieira-mindset-empreendedoras-canal-salto-alto.jpeg', 1, 'mentalidade-financeira', '2024-04-14 11:17:26', '2024-04-14 11:17:26', '2024-04-14 11:17:26');
...
INSERT INTO `csa_users` (`iduser`, `firstname`, `lastname`, `profile_photo`, `cpf`, `birthdate`, `zipcode`, `address_state`, `address_city`, `address`, `address_number`, `address_neighborhood`, `address_complement`, `cellphone`, `email`, `password`, `user_type`, `created_at`, `updated_at`) VALUES
(1, 'Tati Serafim', '', '', '', NULL, '', 0, 0, '', '', '', '', '', 'faleconoscosaltoalto@gmail.com', '', 0, NULL, NULL),
(2, 'Gabriel', 'Carvalho', '', '14962940767', '2000-09-28', '29927000', 8, 71, 'Av. teste', '5', 'Centro', '', '27996039678', 'gabriel@hatoria.com', '$2a$08$MTc3OTE4NTMzNTY2NGE0Z.Dyi3FfRCgyoJiI2AkSjMRXI59FPgyuO', 1, '2024-05-19 16:06:18', NULL);
...
INSERT INTO `csa_users_memberships` (`idusermembership`, `iduser`, `membership_id`, `payment_method`, `payment_value`, `starts_at`, `ends_at`, `status`) VALUES
(1, 2, 1, 'credit_card', 238.90, '2024-06-23 19:46:23', '2025-06-23 19:46:23', '1');
...
--
ALTER TABLE `csa_contents`
  MODIFY `idcontent` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `csa_notices`
  MODIFY `idnotice` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `csa_users_memberships`
  MODIFY `idusermembership` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
