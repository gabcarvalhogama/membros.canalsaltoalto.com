<?php
    class Tutorial
    {
        ...
        */
        ...
        public function create($tutorial_title, $tutorial_content, $author, $status, $published_at) {
            $sql = DB::open()->prepare(
            "INSERT INTO csa_tutorials (tutorial_title, tutorial_content, author, status, published_at, created_at, updated_at)
             VALUES (:title, :content, :author, :status, :published_at, NOW(), NOW())"
            );
