...
<html lang="pt-BR">
	...
	<body class="site">
		...
		<section class="plaintext mt-5 mb-5 site__lp-plaintext bg-gray">
		...
		<section class="plaintext mt-5 mb-5 site__lp-plaintext py-5" style="background-color: #fcfafb;">
			<div class="container-xl">
				<div class="text-center">
					...
					<div class="row text-start mt-5">
						<div class="col-md-4">
							<div class="box bg-white p-5 shadow-sm rounded mb-4">
								<i class="fa-solid fa-snowflake fa-2x mb-2" title="Ambiente climatizado"></i>
								<h3 class="fs-5">Ar-condicionado Individual</h3>
								<p>Ambiente climatizado e confortável para sua produtividade</p>
							</div>
						</div>
						<div class="col-md-4">
							<div class="box bg-white p-5 shadow-sm rounded mb-4">
								<i class="fa-solid fa-wifi fa-2x mb-2" title="Internet alta velocidade"></i>
								<h3 class="fs-5">Internet Alta Velocidade</h3>
								<p>Banda larga premium para trabalhar sem interrupções</p>
							</div>
						</div>
						<div class="col-md-4">
							<div class="box bg-white p-5 shadow-sm rounded mb-4">
								<i class="fa-solid fa-user-group fa-2x mb-2" title="Recepção com Atendente"></i>
								<h3 class="fs-5">Recepção com Atendente</h3>
								<p>Suporte profissional para suas necessidades</p>
							</div>
						</div>
						<div class="col-md-4">
							<div class="box bg-white p-5 shadow-sm rounded mb-4">
								<i class="fa-solid fa-car fa-2x mb-2" title="Estacionamento fácil"></i>
								<h3 class="fs-5">Estacionamento Fácil</h3>
								<p>Acesso conveniente com vagas próximas</p>
							</div>
						</div>
						<div class="col-md-4">
							<div class="box bg-white p-5 shadow-sm rounded mb-4">
								<i class="fa-solid fa-check fa-2x mb-2" title="Salas mobiliadas"></i>
								<h3 class="fs-5">Salas Mobiliadas</h3>
								<p>Ambiente completo e pronto para uso</p>
							</div>
						</div>
						<div class="col-md-4">
							<div class="box bg-white p-5 shadow-sm rounded mb-4">
								<i class="fa-solid fa-clock fa-2x mb-2" title="Flexibilidade de horários"></i>
								<h3 class="fs-5">Flexibilidade Total</h3>
						...
						<div class="col-12">
							<div class="box bg-white p-5 shadow-sm rounded mb-4">
								<h3 class="fs-5">Sala com Maca Disponível</h3>
								<p>Opção especial para serviços estéticos ou terapêuticos, com todo o conforto e privacidade que você precisa.</p>
							</div>
						</div>
					</div>
		...
		<!-- <section class="plaintext mt-5 mb-5 site__lp-plaintext">
			<div class="container-xl">
				<div class="row align-items-center">
					<div class="col-md-8">
						<h2>Loja Colaborativa em Linhares</h2>
						<p>Para empreendedoras que trabalham com produtos físicos, a Loja Colaborativa do Canal Salto Alto é o espaço ideal. Aqui você encontra:</p>

						<ul>
							<li><i class="fa-solid fa-check"></i> Um local acessível para expor e vender seus produtos.</li>
							<li><i class="fa-solid fa-check"></i> Atendimento exclusivo por uma funcionária capacitada.</li>
							<li><i class="fa-solid fa-check"></i> Divulgação constante em nossas redes sociais e canais de venda.</li>
							<li><i class="fa-solid fa-check"></i> Preços acessíveis e infraestrutura completa.</li>
						</ul>
			...
			<div class="container-xl">
				<div class="row align-items-center justify-content-center">
					<div class="col-md-8 text-center">
						...
						<ul>
							<li><i class="fa-solid fa-check"></i> Profissionalizar seu negócio.</li>
							<li><i class="fa-solid fa-check"></i> Ampliar sua rede de contatos com outras empreendedoras da nossa comunidade.</li>
							<li><i class="fa-solid fa-check"></i> Participar de eventos exclusivos e fortalecer seu posicionamento no mercado.</li>
						</ul>
