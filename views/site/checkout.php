...
<html lang="pt-BR">
	...
	<body class="checkout">
		...
		<div class="container-xl mt-3 checkout__header">
						...
						<form action="javascript:void(0)" method="post" onsubmit="Checkout.checkoutEnterpreneur(this)">
							...
							<div class="row mb-3">
								<div class="col">
									...
									<input type="email" class="form-control" id="f_email" name="f_email" placeholder="Ex.: meuemail@gmail.com" required tabindex="1" />
								</div>
							</div>
